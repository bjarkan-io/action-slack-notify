...
WORKDIR ${GOPATH}/src/github.com/bjarkan-io/action-slack-notify
COPY main.go ${GOPATH}/src/github.com/bjarkan-io/action-slack-notify
...
FROM alpine:cmptech/auto_alpine_latest
